...
class SimplePage(tk.Frame):
    ...
    def __init__(self,parent=None, **kwargs):
        ...
        self.typedic = {'.jpg':[0,0,0],'.png':[0,0,0],'.tiff':[0,0,0]}
        self.imgdir = os.getcwd()
        
        self.todelete = tk.BooleanVar(parent)
        self.todelete.set(False)
        
        self.deltextinfo = tk.StringVar(parent)
    ...
    def main_panel(self):
        ...
        self.delonframe = LabelFrame(self.f_main_panel,text="After conversion - Delete old files?")
    ...
    def convert(self):
        #TODO: Script for converting files.
        print("Converting")
